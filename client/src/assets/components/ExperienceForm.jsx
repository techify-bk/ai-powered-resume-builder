...
const ExperienceForm = ({data, onChange}) => {
  ...
  const generateDescription = async (index) => {
    ...
    const prompt = `Enhance this job experience ${experience.description} for the position of ${experience.position} at ${experience.company}.`
          ...
          {data.map((experience, index)=>(
            <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
              ...
              <div className='space-y-2'>
                ...
                <textarea value={experience.description || ""} onChange={(e)=> updateExperience(index, "description", e.target.value)} rows={4} className='w-full text-sm px-3 py-2 rounded-lg resize-none' placeholder='Describe your key responsibilites and achievements...'/>
