  ...
  return (
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
       ...
       <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border border-green-200 rounded-full px-6 py-1.5">
        ...
        <Title title='Build your resume' description='Our streamlined proccess helps you create a professionals resume in minutes with intelligent AI-powered tools and features.'/>
