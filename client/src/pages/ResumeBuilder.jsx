...
import SkillsForm from '../assets/components/SkillsForm'
...
const ResumeBuilder = () => {
  ...
  const changeResumeVisibility = async () => {
    try {
      // FIX: Clone the entire data object and update visibility to prevent 400 validation error
      ...
      // FIX: Explicitly add multipart/form-data header
  ...
  const saveResume = async () => {
    try {
      ...
      // FIX: Check instanceof File so it doesn't crash if image is `null`
            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
                ...
                <div className='flex items-center'>
                  ...
                  {/* FIX: Corrected syntax for template literal interpolation -> ${activeSectionIndex...} */}
              ...
              <div className='space-y-6'>
...

                {
                  ...
                  <button onClick={() => { toast.promise(saveResume(), { loading: 'Saving...', success: (data) => data?.message || 'Saved successfully!', error: 'Error saving resume' }) }} className='bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                    Save Changes
                  </button>
            </div>
